                ...
                <tr key={business.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm text-slate-600">
                      <span className="font-medium">{business._count.orders}</span> orders, {' '}
                      <span className="font-medium">{business._count.subscriptions}</span> subs, {' '}
                      <span className="font-medium">{business._count.customers}</span> customers
                    </div>
                  </td>
                  <td className="px-6 py-4">
